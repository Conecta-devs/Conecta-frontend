...
<template>
  ...
  >
    <div class="header-text">
      <p class="header-eyebrow m-0 text-[10px] font-bold uppercase tracking-[1.1px] text-[#8b94a6]">
        {{ data.weekday }}, {{ data.day }} de
        {{ today.toLocaleDateString('pt-BR', { month: 'long' }) }} de {{ data.year }}
      </p>
      <h1
